...
/* ── Column definitions for call screener results ── */
...
export default function CallScreenerPage() {
  /* Key connectivity */
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const res = await apiFetch('/api/screen/calls', {
        method: 'POST',
  ...
  if (statusLoading) {
    return (
      <div className="max-w-4xl">
        <h1 className="text-2xl font-bold text-gray-900">Call Screener</h1>
  ...
  return (
    <div className="max-w-4xl">
      ...
      <p className="mt-2 text-gray-600">
        Screen for covered calls on a position you hold.
      </p>
      ...
      >
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-gray-500">
            Ticker symbol of the stock you hold
          </p>
        </div>
